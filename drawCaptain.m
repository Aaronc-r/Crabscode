...
% change what it returns to [captainGraphics, xNet, yNet]
...
captainGraphics(17) = drawLine(pt20 , pt21, 'k');
captainGraphics(18) = drawLine(pt21 , pt22, 'k');
captainGraphics(19) = drawLine(pt22 , pt19, 'k');
